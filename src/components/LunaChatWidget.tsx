      ...
      <AnimatePresence>
        {!isOpen && nudge && (
          <m.div
            ...
            className="luna-floating fixed bottom-[10.5rem] md:bottom-24 right-6 z-[9999] max-w-[260px] hidden md:block"
            role="dialog"
      ...
      <AnimatePresence>
        {!isOpen && (
          <m.div
            ...
            className="luna-floating fixed md:bottom-6 right-6 z-[9999] hidden md:flex flex-col items-center gap-1.5"
          >
            <m.button
              onClick={handleOpen}
