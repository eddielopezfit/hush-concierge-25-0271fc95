...
import { Clock, Layers, ChevronRight, Sparkles, CalendarClock, Plus } from "lucide-react";
...
const visitTypeMap: Record<string, { label: string; emoji: string }> = {
  transform: { label: "Transformation", emoji: "✨" },
  refresh:   { label: "Maintenance", emoji: "🔄" },
  relax:     { label: "Relaxation", emoji: "🧘" },
  event:     { label: "Event Prep", emoji: "🌟" },
};
