...
export const teamMembers: TeamMember[] = [
  // Founders
  { id: "f1", name: "Sheri Turner", department: "founders", role: "founder", photo: imgSheriTurner, specialty: "Co-Founder · Hair", specialties: ["Leadership", "Vision"], description: "Visionary co-founder leading Hush since 2002.", bestFor: "Guests who value the original Hush experience", fitStatement: "The heart of Hush — 24 years of setting the standard.", knownFor: ["Original Hush vision", "Behind-the-chair leadership"], badge: "Founding", legacyBio: "For 24 years they have been \"living on a prayer\" building a salon where style, passion, and friendship take center stage. Like true \"free birds\", their salon has stood the test of time, turning every cut, color and style into a \"stairway to heaven\" for their clients. With the hearts of \"small-town girls\", they've built more than a business — they've created a community that stands by them, believing every day is a great day when you look your best.", serviceCategory: "hair", isPrimaryBooking: true, instagram: "sheriturner61" },
  { id: "f2", name: "Danielle Colucci", department: "founders", role: "founder", photo: imgDanielleColucci, specialty: "Co-Founder · Hair", specialties: ["Leadership", "Community"], description: "Co-founder driven by community and creativity.", bestFor: "Guests looking for warmth and expertise", fitStatement: "Built the culture that makes Hush feel like home — 24 years behind the chair.", knownFor: ["Community building", "Creative direction"], badge: "Founding", legacyBio: "For 24 years they have been \"living on a prayer\" building a salon where style, passion, and friendship take center stage. With a deep love for their staff, craft and hometown, they are here to make sure every client leaves feeling like a rock star!", serviceCategory: "hair", isPrimaryBooking: true, instagram: "daniellecolucci1" },
  { id: "f3", name: "Kathy Crawford", department: "founders", role: "founder", photo: imgKathyCrawford, specialty: "Co-Founder · Hair", specialties: ["Leadership", "Client Care"], description: "Co-founder dedicated to guest care.", bestFor: "Guests who want personalized attention", fitStatement: "Ensures every guest feels seen, heard, and cared for — 24 years strong.", knownFor: ["Personalized attention", "Quality assurance"], badge: "Founding", legacyBio: "Thanks to the love and support of their loyal clients, they're standing stronger than ever, proving great hair never goes out of style. With a deep love for their staff, craft and hometown, they are here to make sure every client leaves feeling like a rock star!", serviceCategory: "hair", isPrimaryBooking: true, instagram: "kcwiththecoolhair" },
  // Hair Stylists
  { id: "h1", name: "Charly Camano", department: "hair", role: "stylist", photo: imgCharlyCamano, specialty: "Color & Waves", specialties: ["Color", "Waves", "Styling"], description: "Expert in color techniques and textured waves.", bestFor: "Lived-in color and beachy texture", fitStatement: "Great for lived-in color and effortless texture.", knownFor: ["Beachy waves", "Lived-in color", "Effortless styling"], legacyBio: "This \"wild thing will make your hair sing\". A fashionista soul who cranks up the volume. Fueled by a \"spirit in the sky\", she crafts killer waves, rebellious hues and head-turning clips that own the spotlight. A true star who \"shines bright like a diamond\"!", serviceCategory: "hair", isPrimaryBooking: true, instagram: "charlys_chair" },
  ...
  { id: "h3", name: "Silviya Warren", department: "hair", role: "stylist", photo: imgSilviyaWarren, specialty: "High Fashion Color", specialties: ["Fashion Color", "Artistic Color"], description: "Specializing in bold, editorial color work.", bestFor: "Bold transformations and vivid color", fitStatement: "A strong option for editorial looks and vivid color.", knownFor: ["Fashion color", "Vivid tones", "Bold transformations"], legacyBio: "Meet Silviya, where high fashion meets high voltage. With a passion for runway-worthy looks, bold colors and flawless finishes, she turns every client into a chart-topping masterpiece. With a heart of gold and extra-care customer service, she pampers, perfects and delivers a look that's simply the best — \"better than all the rest!\"", serviceCategory: "hair", isPrimaryBooking: true, instagram: "hairdesignsbysilviya" },
  { id: "h4", name: "Whitney Hernandez", department: "hair", role: "stylist", photo: imgWhitneyHernandez, specialty: "Dimensional Blondes & Updos", specialties: ["Blondes", "Updos", "Dimensional Color"], description: "Creating luminous blondes and stunning updo artistry.", bestFor: "Blonding, events, and bridal", fitStatement: "Great for dimensional blondes and event-ready styling.", knownFor: ["Luminous blondes", "Bridal updos", "Event styling"], legacyBio: "Whitney is a \"Blonde Ambition\" hairstylist who rocks at creating dimensional blondes and romantic updos that leave clients feeling like \"Sweet Child O' Mine.\" A proud mom of two, she knows how to balance \"Livin' on a Prayer\" with her passion for hair. Whether she's teasing out volume or fine-tuning the perfect tone, she believes every style should make you feel like a \"Rockstar.\"", serviceCategory: "hair", isPrimaryBooking: true, instagram: "prettyhairandpositivity", featuredReview: { quote: "Whitney is the best with blondes!! I asked for 'beige' hair, not golden, not ashy. And she nailed it!!!", author: "Andrea Mitchell", source: "Facebook" } },
  { id: "h5", name: "Kathy Charette", department: "hair", role: "stylist", photo: imgKathyCharette, specialty: "Cuts & Color", specialties: ["Haircuts", "Color"], description: "Precision cuts paired with beautiful color.", bestFor: "Clean cuts and reliable color", fitStatement: "Specializes in clean, precise cuts and reliable color work.", knownFor: ["Precision cuts", "Reliable color", "Maintenance appointments"], legacyBio: "With experienced hands and a rebel's touch, Kathy makes sure every client feels good in their skin. From head-banging cuts to cool colors, she knows what tunes you crave. You'll \"cry for more, more, more\".", serviceCategory: "hair", isPrimaryBooking: true, instagram: "kcharetteq", featuredReview: { quote: "FINALLY! I have found a great stylist in Arizona! Kathy is AMAZING! She is very skilled and knew exactly how to cut my thick, but fine hair.", author: "Alicia Robinson", source: "Facebook" } },
  { id: "h6", name: "Allison Griessel", department: "hair", role: "stylist", photo: imgAllisonGriessel, specialty: "Creative Color, Esthetics & Lashes", specialties: ["Creative Color", "Esthetics", "Facials", "Skincare", "Classic Lashes", "Volume Lashes", "Lash Lifts"], description: "Dual-trained in creative color, esthetics, and lash artistry.", bestFor: "Creative color + skincare + lashes in one visit", fitStatement: "One of the few artists trained in color, skincare, and lashes.", knownFor: ["Multi-service visits", "Creative color + lashes", "Skincare crossover"], legacyBio: "Dreaming of \"purple rain\" or \"cherry bomb\" reds? Let Allison \"rock you down the electric avenue\" of full-spectrum colors. She's ready to make your color vision a reality. Get ready to kiss boring hair goodbye and walk out like a living, breathing encore!", serviceCategory: "hair", serviceCategories: ["hair", "skincare", "lashes"], directPhone: "(520) 250-6606", isPrimaryBooking: true, instagram: "allieglam", featuredReview: { quote: "Allison G is magical. I've gotten nonstop compliments on my hair since seeing her.", author: "Megan Petersen", source: "Google Review" } },
  { id: "h7", name: "Melissa Brunty", department: "hair", role: "stylist", photo: imgMelissaBrunty, specialty: "Extensions & Long Hair", specialties: ["Extensions", "Long Hair"], description: "Seamless extensions and long hair transformations.", bestFor: "Length, volume, and extensions", fitStatement: "The go-to for length, volume, and seamless extensions.", knownFor: ["Seamless extensions", "Long hair transformations", "Volume adds"], legacyBio: "\"She's got a ticket to ride\" when it comes to long hair, chemical romances, and making your dream look a reality. With a sharp eye and a listening ear, she ensures every client gets exactly what they want because \"nothing else matters\" but you. If you're craving sleek lengths, bombshell blonds or total reinvention, she's ready to \"pour some sugar on\" your hair and make it rock!", serviceCategory: "hair", isPrimaryBooking: true, instagram: "mbhaircreations" },
  { id: "h8", name: "Ana Moreno", department: "hair", role: "stylist", photo: imgAnaMoreno, specialty: "Color, Cuts & Styling", specialties: ["Color", "Cuts", "Styling"], description: "Versatile stylist skilled in color, cuts, and finishing.", bestFor: "Versatile everyday looks", fitStatement: "The go-to for versatile everyday looks and easy-to-maintain color.", knownFor: ["Everyday styling", "Versatile cuts", "Low-maintenance color"], legacyBio: "She's \"breaking the law\" of boring hair with expert color, cutting and styling that turns heads. With a passion for creativity and a respectful touch, she listens to your vision and makes it a reality. Sit in her chair, and get ready to \"rock and roll all night\" with a style that's as bold or classic as you want!", serviceCategory: "hair", isPrimaryBooking: true, instagram: "_missanaa" },
  { id: "h9", name: "Priscilla", department: "hair", role: "stylist", photo: imgPriscilla, specialty: "Color & Cuts", specialties: ["Color", "Cuts"], description: "Reliable artistry in color and precision cutting.", bestFor: "Dependable quality every visit", fitStatement: "The go-to for clients who want precision and consistency every visit.", knownFor: ["Consistent quality", "Precision cutting", "Reliable color"], legacyBio: "Priscilla's a \"dancing queen\" with a gentle touch, turning every color and cut into a work of art. With her peaceful nature, she makes you feel like you're the only person in the room, fully seen and heard. Sit back, relax, and let her \"paint your hair like a rockstar\" while you enjoy the calm and creativity she brings.", serviceCategory: "hair", isPrimaryBooking: true, instagram: "priscilla.blossoms" },
  { id: "h10", name: "Zaida Delgado", department: "hair", role: "stylist", photo: imgZaidaDelgado, specialty: "Bold Transformations", specialties: ["Transformations", "Bold Color"], description: "Fearless approach to dramatic hair transformations.", bestFor: "Dramatic makeovers", fitStatement: "The go-to for bold makeovers and total transformations.", knownFor: ["Dramatic makeovers", "Bold color shifts", "Total transformations"], legacyBio: "Zaida's a \"wild thing\" who lives for hair, color, and bold transformations. Her creativity and passion make every client feel like the only person in the room. Sit in her chair and get ready to \"let your hair down\" and rock a look that turns heads!", serviceCategory: "hair", isPrimaryBooking: true, instagram: "styled_by_zaida" },
  // Front Desk
  { id: "fd1", name: "Kendell Barraza", department: "front-desk", role: "coordinator", photo: imgKendellBarraza, specialty: "Guest Experience", specialties: ["Guest Services", "Scheduling"], description: "Your first point of contact and concierge guide.", bestFor: "Booking help and questions", fitStatement: "Your first point of contact — she can help with any question.", knownFor: ["Scheduling", "Guest coordination"], legacyBio: "Kendell is the \"heart of rock 'n' roll\" at the front desk, welcoming every guest with a smile. She keeps the salon running smooth by greeting clients, booking appointments, and making sure everything stays on track. Smart, quick, and always on it, she helps the whole place \"rock and roll all night.\"", serviceCategory: null, isPrimaryBooking: false, instagram: "a_kendallbarraza" },
  // Esthetics
  { id: "e1", name: "Patty", department: "skincare", role: "esthetician", photo: imgPatty, specialty: "Facials & Skincare", specialties: ["Facials", "Skincare", "Spray Tan"], description: "Results-driven skincare and facial treatments.", bestFor: "Clear skin and custom facials", fitStatement: "A strong option for results-driven facials and skin-focused self-care.", knownFor: ["Custom facials", "Clear skin results", "Spray tans"], directPhone: "(520) 870-6048", legacyBio: "Patty's touch is like \"a stairway to heaven\" — smooth, gentle, and guiding your skin to radiant perfection. With a blend of skilled techniques, she customizes every facial to \"keep on shining\" and bring out your natural beauty. Whether you want to \"rock and roll all night\" or simply relax and rejuvenate, Patty's care hits every note just right.", serviceCategory: "skincare", isPrimaryBooking: true },
  ...
  // Nail Technicians
  { id: "n1", name: "Anita Apodaca", department: "nails", role: "nail-tech", photo: imgAnitaApodaca, specialty: "Nail Tech & Educator", specialties: ["Nail Art", "Education", "Extensions"], description: "Nail artistry educator with a passion for nail art.", bestFor: "Creative nail designs", fitStatement: "Guests often choose her for creative designs and nail artistry.", knownFor: ["Creative nail art", "Nail education", "Custom designs"], directPhone: "(520) 591-0208", legacyBio: "With a passion for nail extensions and jaw-dropping nail art, Anita's work will have you feeling like you've got \"the look that kills.\" A seasoned pro and former educator, she's taught countless techs how to \"shine on, you crazy diamond.\" Whether you're after glam, edge, or full-on rockstar nails, Anita brings the stage presence every time.", serviceCategory: "nails", isPrimaryBooking: true, instagram: "anita.b.apodaca" },
  { id: "n2", name: "Kelly Vishnevetsky", department: "nails", role: "nail-tech", photo: imgKellyVishnevetsky, specialty: "Pedicures & Extensions", specialties: ["Pedicures", "Extensions"], description: "Expert in pedicures and nail extensions.", bestFor: "Pedicures and nail extensions", fitStatement: "Specializes in pedicures and extensions — a great fit for full nail care.", knownFor: ["Pedicures", "Nail extensions", "Full nail care"], directPhone: "(520) 488-7149", legacyBio: "Kelly creates pedicures and nail extensions that \"shine like a diamond in the sky\" — bold, beautiful, and built to last. Her style is calm, confident, and free-spirited. She believes every set of nails tells a story, and she's here to make yours \"a whole lotta love.\"", serviceCategory: "nails", isPrimaryBooking: true },
  { id: "n3", name: "Jackie", department: "nails", role: "nail-tech", photo: imgJackie, specialty: "Nail Art & Extensions", specialties: ["Nail Art", "Extensions"], description: "Creative nail art and extension specialist.", bestFor: "Trendy nail art", fitStatement: "A great fit for trendy designs and statement nails.", knownFor: ["Trendy nail art", "Statement designs", "Extensions"], directPhone: "(520) 501-6861", legacyBio: "Jackie's got \"the glam, the glitter, and the gallop\" — turning every nail set into a power ballad for your hands. She works like \"she was born to be wild\" with a brush in one hand and reins in the other. With Jackie, it's all sparkle, style, and \"a whole lotta love.\"", serviceCategory: "nails", isPrimaryBooking: true },
  // Massage
  { id: "m1", name: "Tammi", department: "massage", role: "massage-therapist", photo: null, specialty: "Massage Therapist", specialties: ["Massage", "Relaxation", "Therapeutic", "Deep Tissue", "Swedish"], description: "Therapeutic touch that restores balance and renews spirit.", bestFor: "Deep relaxation and recovery", fitStatement: "Specializes in customized pressure — great for stress relief and recovery.", knownFor: ["Stress relief", "Deep tissue", "Swedish massage", "Customized pressure"], legacyBio: "Tammi hits all the right notes — from deep tissue to soothing Swedish, she customizes every session like a personal encore. With hands that \"roll like thunder\" and a rhythm all her own, she melts tension and leaves stress in the dust. Whether you need to \"break on through\" tight muscles or just want to \"take it easy,\" Tammi tunes into your body's needs like a true headliner.", serviceCategory: "massage", directPhone: "(520) 370-3018", isPrimaryBooking: true, instagram: "tammi.silva.737" },
