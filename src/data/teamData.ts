...
export const teamMembers: TeamMember[] = [
  ...
  // Esthetics
  { id: "e1", name: "Patty", department: "skincare", role: "esthetician", photo: imgPatty, specialty: "Facials & Skincare", specialties: ["Facials", "Skincare", "Spray Tan"], description: "Results-driven skincare and facial treatments.", bestFor: "Clear skin and custom facials", fitStatement: "The go-to for results-driven facials and skin-focused self-care.", knownFor: ["Custom facials", "Clear skin results", "Spray tans"], legacyBio: "Patty's touch is like \"a stairway to heaven\" — smooth, gentle, and guiding your skin to radiant perfection. With a blend of skilled techniques, she customizes every facial to \"keep on shining\" and bring out your natural beauty. Whether you want to \"rock and roll all night\" or simply relax and rejuvenate, Patty's care hits every note just right.", serviceCategory: "skincare", isPrimaryBooking: true },
  { id: "e2", name: "Lori", department: "skincare", role: "esthetician", photo: imgLori, specialty: "Facials & Skincare", specialties: ["Facials", "Skincare"], description: "Dedicated to healthy, glowing skin.", bestFor: "Gentle, nurturing skin care", fitStatement: "The go-to for gentle, nurturing skincare and glow treatments.", knownFor: ["Gentle approach", "Nurturing treatments", "Healthy glow"], legacyBio: "Lori's touch is \"like a prayer,\" smooth and soft but packed with power to make your skin \"dance with an angel\" — glowing and flawless every time. She customizes every facial to \"rock you like a hurricane\" while keeping it \"easy like Sunday morning.\" With Lori, your skin won't just shine, it'll \"light up the night\" like a true glam queen.", serviceCategory: "skincare", isPrimaryBooking: true },
  // Nail Technicians
  { id: "n1", name: "Anita Apodaca", department: "nails", role: "nail-tech", photo: imgAnitaApodaca, specialty: "Nail Tech & Educator", specialties: ["Nail Art", "Education", "Extensions"], description: "Nail artistry educator with a passion for nail art.", bestFor: "Creative nail designs", fitStatement: "The go-to for creative nail art and custom designs.", knownFor: ["Creative nail art", "Nail education", "Custom designs"], legacyBio: "With a passion for nail extensions and jaw-dropping nail art, Anita's work will have you feeling like you've got \"the look that kills.\" A seasoned pro and former educator, she's taught countless techs how to \"shine on, you crazy diamond.\" Whether you're after glam, edge, or full-on rockstar nails, Anita brings the stage presence every time.", serviceCategory: "nails", isPrimaryBooking: true },
  { id: "n2", name: "Kelli", department: "nails", role: "nail-tech", photo: imgKellyVishnevetsky, specialty: "Pedicures & Extensions", specialties: ["Pedicures", "Extensions"], description: "Expert in pedicures and nail extensions.", bestFor: "Pedicures and nail extensions", fitStatement: "The go-to for pedicures, extensions, and full nail care.", knownFor: ["Pedicures", "Nail extensions", "Full nail care"], legacyBio: "Kelli creates pedicures and nail extensions that \"shine like a diamond in the sky\" — bold, beautiful, and built to last. Her style is calm, confident, and free-spirited. She believes every set of nails tells a story, and she's here to make yours \"a whole lotta love.\"", serviceCategory: "nails", isPrimaryBooking: true },
  { id: "n3", name: "Jacky", department: "nails", role: "nail-tech", photo: imgJackie, specialty: "Nail Art & Extensions", specialties: ["Nail Art", "Extensions"], description: "Creative nail art and extension specialist.", bestFor: "Trendy nail art", fitStatement: "The go-to for trendy designs and statement nails.", knownFor: ["Trendy nail art", "Statement designs", "Extensions"], legacyBio: "Jacky's got \"the glam, the glitter, and the gallop\" — turning every nail set into a power ballad for your hands. She works like \"she was born to be wild\" with a brush in one hand and reins in the other. With Jacky, it's all sparkle, style, and \"a whole lotta love.\"", serviceCategory: "nails", isPrimaryBooking: true },
  // Massage
  { id: "m1", name: "Tammi", department: "massage", role: "massage-therapist", photo: null, specialty: "Massage Therapist", specialties: ["Massage", "Relaxation", "Therapeutic"], description: "Therapeutic touch that restores balance and renews spirit.", bestFor: "Deep relaxation and recovery", fitStatement: "The go-to for customized pressure, stress relief, and recovery.", knownFor: ["Stress relief", "Deep tissue support", "Customized pressure", "Therapeutic recovery"], legacyBio: "Tammi hits all the right notes — from deep tissue to soothing Swedish, she customizes every session like a personal encore. With hands that \"roll like thunder\" and a rhythm all her own, she melts tension and leaves stress in the dust. Whether you need to \"break on through\" tight muscles or just want to \"take it easy,\" Tammi tunes into your body's needs like a true headliner.", serviceCategory: "massage", directPhone: "(520) 370-3018", isPrimaryBooking: true },
