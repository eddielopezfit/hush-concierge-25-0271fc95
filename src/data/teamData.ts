...
export const teamMembers: TeamMember[] = [
  ...
  { id: "h10", name: "Zaida Delgado", department: "hair", role: "stylist", photo: imgZaidaDelgado, specialty: "Bold Transformations", specialties: ["Transformations", "Bold Color"], description: "Fearless approach to dramatic hair transformations.", bestFor: "Dramatic makeovers", fitStatement: "The go-to for bold makeovers and total transformations.", knownFor: ["Dramatic makeovers", "Bold color shifts", "Total transformations"], legacyBio: "Zaida's a \"wild thing\" who lives for hair, color, and bold transformations. Her creativity and passion make every client feel like the only person in the room. Sit in her chair and get ready to \"let your hair down\" and rock a look that turns heads!", serviceCategory: "hair", isPrimaryBooking: true },
  // Front Desk
  ...
  // Massage
  { id: "m1", name: "Tammy", department: "massage", role: "massage-therapist", photo: null, specialty: "Massage Therapist", specialties: ["Massage", "Relaxation", "Therapeutic", "Deep Tissue", "Swedish"], description: "Therapeutic touch that restores balance and renews spirit.", bestFor: "Deep relaxation and recovery", fitStatement: "Specializes in customized pressure — great for stress relief and recovery.", knownFor: ["Stress relief", "Deep tissue", "Swedish massage", "Customized pressure"], legacyBio: "Tammy hits all the right notes — from deep tissue to soothing Swedish, she customizes every session like a personal encore. With hands that \"roll like thunder\" and a rhythm all her own, she melts tension and leaves stress in the dust. Whether you need to \"break on through\" tight muscles or just want to \"take it easy,\" Tammy tunes into your body's needs like a true headliner.", serviceCategory: "massage", directPhone: "(520) 370-3018", isPrimaryBooking: true },
