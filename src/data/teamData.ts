...
export const teamMembers: TeamMember[] = [
  // Founders
  { id: "f1", name: "Sheri Turner", department: "founders", role: "founder", photo: imgSheriTurner, specialty: "Co-Founder", specialties: ["Leadership", "Vision"], description: "Visionary co-founder leading Hush since 2002.", bestFor: "Guests who value the original Hush experience", fitStatement: "The heart of Hush — 23 years of setting the standard.", knownFor: ["Original Hush vision", "Behind-the-chair leadership"], badge: "Founding", legacyBio: "For 24 years they have been \"living on a prayer\" building a salon where style, passion, and friendship take center stage. Like true \"free birds\", their salon has stood the test of time, turning every cut, color and style into a \"stairway to heaven\" for their clients. With the hearts of \"small-town girls\", they've built more than a business — they've created a community that stands by them, believing every day is a great day when you look your best.", serviceCategory: "hair", isPrimaryBooking: false },
  { id: "f2", name: "Danielle Colucci", department: "founders", role: "founder", photo: imgDanielleColucci, specialty: "Co-Founder", specialties: ["Leadership", "Community"], description: "Co-founder driven by community and creativity.", bestFor: "Guests looking for warmth and expertise", fitStatement: "Built the culture that makes Hush feel like home.", knownFor: ["Community building", "Creative direction"], badge: "Founding", legacyBio: "For 24 years they have been \"living on a prayer\" building a salon where style, passion, and friendship take center stage. With a deep love for their staff, craft and hometown, they are here to make sure every client leaves feeling like a rock star!", serviceCategory: "hair", isPrimaryBooking: false },
  { id: "f3", name: "Kathy Crawford", department: "founders", role: "founder", photo: imgKathyCrawford, specialty: "Co-Founder", specialties: ["Leadership", "Client Care"], description: "Co-founder dedicated to guest care.", bestFor: "Guests who want personalized attention", fitStatement: "Ensures every guest feels seen, heard, and cared for.", knownFor: ["Personalized attention", "Quality assurance"], badge: "Founding", legacyBio: "Thanks to the love and support of their loyal clients, they're standing stronger than ever, proving great hair never goes out of style. With a deep love for their staff, craft and hometown, they are here to make sure every client leaves feeling like a rock star!", serviceCategory: "hair", isPrimaryBooking: false, instagram: "kcwiththecoolhair" },
  // Hair Stylists
