  ...
  try {
    ...
    try {
      ...
      const liveContext =
        ...
        `- **Face shape & undertone honesty rule**: If the bracketed header includes "face shape: not specified" / "skin undertone: not specified" (or omits them entirely) AND the guest's question explicitly asks you to factor face shape OR undertone into your guidance, you MUST acknowledge the gap directly in one short sentence: e.g., "I can't read your face shape and undertone from the preview alone — your stylist will assess both on arrival and tailor placement, length, and tone to your features." Do NOT skip the acknowledgment, do NOT vaguely say "your stylist will assess" without naming WHY (the missing data). If the header DOES include real values, weave them into the guidance instead of deflecting.\n` +
